...
INSERT INTO `tblbestemming` (`BestemmingID`, `Afkorting`, `Voluit`, `Land`, `TypeVlucht`)
VALUES (527, 'AMS', ' Amsterdam Airport Schiphol', 'Nederland', 1),
...
INSERT INTO `tblhuidigeprijssetting` (`TypeVlucht`, `HuidigePrijsSetting`, `omschrijving`)
VALUES (1, '99.00', 'korte vlucht'),
...
INSERT INTO `tblklant` (`KlantID`, `FNaam`, `VNaam`, `Straat`, `Nummer`, `Postcode`, `Gemeente`)
VALUES (100, 'Bennett', 'Dacey', '867 Varius Ave', '30', 8577, 'Uberlândia'),
...
INSERT INTO `tblvliegtuig` (`VliegtuigID`, `Vliegtuigbouwer`, `Type`, `MaxAantalZitplaatsenInDitToestel`, `InterneCode`)
VALUES (1, 'Airbus', 'A319-100', 20, 'OO-SSP'),
...
INSERT INTO `tblvlucht` (`VluchtNr`, `Vluchtdatum`, `BestemmingID`, `VliegtuigID`)
VALUES (11001, '2019-02-12', 528, 3),
...
INSERT INTO `tblvluchtinformatie` (`VluchtNr`, `StoelNr`, `KlantID`, `PrijsBetaaldVoorStoel`)
VALUES (11001, 1, 101, '99.00'),
       (11001, 2, 101, '99.00'),
       (11001, 3, 102, '99.00'),
       (11001, 4, 104, '99.00'),
       (11001, 5, NULL, NULL),
...
INSERT INTO `tblwerknemer` (`WerknemerID`, `Naam`, `TypeID`, `Foto`)
VALUES (1, 'Els', 1, 'images/wnels.jpg'),
...
INSERT INTO `tblwerknemertypes` (`TypeID`, `Omschrijving`)
VALUES (1, 'Check In'),
       (2, 'Flight organiser');
...
--
ALTER TABLE `tblbestemming`
    MODIFY `BestemmingID` int(11) NOT NULL AUTO_INCREMENT,
    AUTO_INCREMENT = 555;
...
--
ALTER TABLE `tblhuidigeprijssetting`
    MODIFY `TypeVlucht` int(11) NOT NULL AUTO_INCREMENT,
    AUTO_INCREMENT = 3;
...
--
ALTER TABLE `tblvliegtuig`
    MODIFY `VliegtuigID` int(11) NOT NULL AUTO_INCREMENT,
    AUTO_INCREMENT = 9;
...
--
ALTER TABLE `tblvlucht`
    MODIFY `VluchtNr` int(11) NOT NULL AUTO_INCREMENT,
    AUTO_INCREMENT = 11019;

--
-- AUTO_INCREMENT for table `tblwerknemer`
--
ALTER TABLE `tblwerknemer`
    MODIFY `WerknemerID` int(11) NOT NULL AUTO_INCREMENT,
    AUTO_INCREMENT = 4;
