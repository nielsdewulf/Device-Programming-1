...
/*!40000 ALTER TABLE `bestemmingen`
    DISABLE KEYS */;
INSERT INTO `bestemmingen`
VALUES (100, 'Brussel'),
       (101, 'Antwerpen'),
       (102, 'Gent-Sint-Pieters'),
       (103, 'Brugge');
/*!40000 ALTER TABLE `bestemmingen`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `treinen`
    DISABLE KEYS */;
INSERT INTO `treinen`
VALUES (16, '10:00', 100, 12, NULL, 0),
       (17, '10:00', 101, 11, NULL, 0),
       (18, '10:10', 103, 5, 5, 0),
       (19, '10:15', 103, 5, NULL, 1),
       (20, '11:00', 100, 9, NULL, 0),
       (21, '10:10', 103, 6, 30, 0),
       (25, '02:01', 101, 4, 1, 0),
       (26, '11:22', 100, 32, 4, 1),
       (27, '11:22', 101, 5, NULL, 0),
       (28, '22:22', 101, 99, 60, 1),
       (29, '23:00', 100, 99, NULL, 0),
       (30, '11:22', 101, 55, 5, 1),
       (31, '11:11', 100, 34, 5, 1),
       (32, '22:22', 100, 4, 5, 1),
       (34, '04:11', 102, 4, 5, 0),
...
-- Dump completed on 2019-03-13 20:32:45
