"use strict";
let APIKey = "068c722aab455136e474720e15d9cad2";
...
const verwerkWeer = function (json) {
    ...
    for (let i = 0; i < json.list.length; i += 8) {
        ...
        str += `<div class="dag">
            ...
            <div class="afbeelding">
              <img src="images/weather/${weatherCodeToImage(
            obj.weather[0].id
            ...
            <div class="wind">
            <img src="images/weather/${directionToImage(
            parseFloat(obj.wind.deg)
        )}" alt="${obj.wind.deg}" />
            <img src="images/weather/${strengthToImage(
            parseFloat(obj.wind.speed)
        )}" alt="${obj.wind.speed}" />
            </div>
          </div>`;
    }
...
const weatherCodeToImage = function (code) {
    ...
    return specials[code] !== undefined
        ? specials[code]
        : normal[firstDigit] !== undefined
            ? normal[firstDigit]
            : "wi-alien.svg";
};
